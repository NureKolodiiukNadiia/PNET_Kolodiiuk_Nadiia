        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvgTmdbRating = table.Column<float>(type: "real", nullable: true),
                    ...
                    Actors = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: true),
                    ProductionCompanies = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    SpokenLanguages = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WatchListItems_Titles_TitleId",
                        column: x => x.TitleId,
                        principalTable: "Titles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchListItems_TitleId",
